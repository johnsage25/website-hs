...
import image from '../../../public/img/daily_routine_15.svg'
        ...
        <div className={classes.inner}>
          <div className={classes.content}>
            ...
            <Text className=" text-gray-600" mt="md">
              Strong, inexpensive bare metal with 100% resource allocation
              allows you to accomplish more with less money.
            </Text>
